...
class JapaneseTokenizer:
    def __init__(self, splitter='Kytea', unicode=True, half2full=True, full2half=True, lower_case=True, model=None):
        assert splitter in ('MeCab', 'Kytea', None)
...
def main():
    ...
    tokenizer = JapaneseTokenizer(splitter='Kytea',model="/home/smg/nishikawa/kytea/data/model.bin")
